...
export interface MentalHealthExternalRegisterResultBrowseModelConstructor {
  id: number
  title: string
  description: string
  ...
  professional: {
    name: string
    register: string
    registerType: MedicalRegistrationEnum
  }
}

export class MentalHealthExternalRegisterResultBrowseModel {
  ...
  public readonly professional: {
    ...
    readonly registerType: MedicalRegistrationEnum
  }

  constructor(props: MentalHealthExternalRegisterResultBrowseModelConstructor) {
    this.id = props.id
